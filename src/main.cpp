...
#include <string>
// # gui
#include "gui/vendor/imgui/imgui.h"
#include "gui/vendor/imgui/imgui_impl_dx9.h"
#include "gui/vendor/imgui/imgui_impl_win32.h"
#include <d3d9.h>
#include <tchar.h>
#include <vector>
...
int main(int argc, char *argv[])
{
    ...
    parser.add_argument(
        new std::string[]{"-i", "--product-id"}, 2, TYPE::INNT, "product-id", nullptr,
        "Product ID"
    );
    parser.add_argument(
    ...
    parser.add_argument(
        new std::string[]{"-p", "--price"}, 2, TYPE::DOOUBLE, "price", nullptr,
        "Price of the Product"
    );
    parser.add_argument(
        new std::string[]{"-a", "--available-count"}, 2, TYPE::INNT, "available-count",
        nullptr, "Product ID"
    );
    parser.add_argument(
    ...
    parser.add_argument(
        new std::string[]{"-I", "--order-id"}, 2, TYPE::INNT, "order-id", nullptr,
        "Order ID"
    );
        ...
        parser.parser_error("GUI");
            ...
            // Main code
                ...
                HWND hwnd = ::CreateWindowW(
                    wc.lpszClassName, L"SEYED SHOP", WS_OVERLAPPEDWINDOW, 100, 100,
                ...
                ImFont *mainfont = io.Fonts->AddFontFromFileTTF(
                    "vendor\\imgui\\misc\\fonts\\Lalezar-Regular.ttf", 30
                );
                ...
                style.Colors[ImGuiCol_TitleBgCollapsed] =
                    ImVec4(1.00f, 0.45f, 0.12f, 0.70f);
                style.Colors[ImGuiCol_TitleBgActive] =
                    ImVec4(0.90f, 0.35f, 0.02f, 1.00f);
